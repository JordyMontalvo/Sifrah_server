...
function isSavingsOnlyProduct(product) {
  ...
  if (isPromotionProduct(product)) return false;
...
function savingsCatalogMongoFilter() {
  // Cualquier producto con Bono Ahorro activo aparece en la tienda de canje.
  // (Antes se excluía catalog_type=sifrah, lo que ocultaba productos al activar el toggle.)
